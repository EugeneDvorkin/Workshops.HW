...
namespace Rocket.Web.Controllers.User
{
    ...
    public class UsersController : ApiController
    {
        ...
        public UsersController(
           /* RocketUserManager rocketUserManagerService,*/ IRoleService rolemanager, IUserManagementService userNativeManagementService)
        {
        ...
        public async Task<IHttpActionResult> AddUser([FromBody] BL.Common.Models.User.User user)
        {
            ...
            await _userManagementService.AddUser(
                new BL.Common.Models.User.User()
                {
                    Login = user.Login,
                    ...
                    UserDetail = new UserDetail
                    {
                        ...
                        EMailAddresses = new List<EmailAddress>() { (new EmailAddress() { Address = user.Login }) }
                    }
                }
